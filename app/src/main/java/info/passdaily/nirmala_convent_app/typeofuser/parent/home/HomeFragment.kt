package info.passdaily.nirmala_convent_app.typeofuser.parent.home
...
import info.passdaily.nirmala_convent_app.databinding.FragmentHomeBinding
...
import info.passdaily.nirmala_convent_app.lib.video.Video_Activity
...
import info.passdaily.nirmala_convent_app.typeofuser.parent.event.ManageEventDialog
            ...
            .observe(requireActivity(), Observer {
                it?.let { resource ->
                    ...
                    when (resource.status) {
                        Status.SUCCESS -> {
                            val response = resource.data?.body()!!
//                                Utils.getSnackBarGreen(requireActivity(),"Opening YouTube",binding.nestedScroll)
